...
//                 <div className="footerinner_
//                 _top cf">
//                     <h2><a href="index.do"><img src="/img/logo.png" alt="로고"/></a></h2>
//                     <div className="top__links">
//                         <div className="links__sns cf">
//                             <a href="https://ko-kr.facebook.com/chungmuartscenter/" target="_blank"><i
//                                 className="fab fa-facebook-f fa-2x"></i></a>
//                             <a href="https://twitter.com/chungmuholic" target="_blank"><i
//                                 className="fab fa-twitter fa-2x"></i></a>
//                             <a href="/admin/" target="_blank"><i className="fab fa-instagram fa-2x"></i></a>
//                             <a href="https://blog.naver.com/cmah_arthall" target="_blank"><i
//                                 className="xi-naver xi-2x"></i></a>
//                             <a href="https://www.youtube.com/channel/UC4UWAAwSsT4O3hcLjFL8kXQ" target="_blank"><i
