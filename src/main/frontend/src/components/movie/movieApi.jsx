...
export default class MovieApi extends Component{
    ...
    render() {
        ...
        const url = " http://api.koreafilm.or.kr/openapi-data2/wisenut/search_api/search_json2.jsp?collection=kmdb_new2&title=" + encodeURI(this.state.title) + '&ServiceKey=' + ServiceKey;
